...
public class EncodedDecodeUtils {
     ...
     * @throws Exception 
     */  
    public static byte[] decodeByPrivateKey(byte[] data, byte[] key)  
            throws Exception {  
     ...
     * @throws Exception 
     */  
    public static byte[] decodeByPublicKey(byte[] data, byte[] key)  
            throws Exception {  
     ...
     * @throws Exception 
     */  
    public static byte[] encodeByPublicKey(byte[] data, byte[] key)  
            throws Exception {  
     ...
     * @throws Exception 
     */  
    public static byte[] encodeByPrivateKey(byte[] data, byte[] key)  
            throws Exception {  
    ...
    public static String base64EncodeSafe(String data) throws Exception {  
	 ...
	 * ===========================   MD5加密    ===========================
	 */
	public static byte[] md5Encoded(String encodedStr) throws Exception {
		return DigestUtils.md5(encodedStr);
	}
	
	public static String md5HexEncoded(String encodedStr) throws Exception {
		return DigestUtils.md5Hex(encodedStr);
	}
